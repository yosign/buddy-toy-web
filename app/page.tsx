...
`  .---------.
  ...
  \`---------\``
          ...
          <div
            className="rounded-xl border bg-zinc-950 w-full transition-all duration-500"
            style={{
              borderColor: companion.shiny
                ? (RARITY_COLOR[companion.rarity] ?? '#a1a1aa')
                : 'rgb(39,39,42)',
              boxShadow: companion.shiny
                ? `0 0 24px 4px ${RARITY_COLOR[companion.rarity] ?? '#a1a1aa'}55, 0 0 8px 2px ${RARITY_COLOR[companion.rarity] ?? '#a1a1aa'}33`
          ...
          >
            ...
            <div className="flex items-center gap-2 px-4 py-2 bg-zinc-900 border-b border-zinc-800 rounded-t-xl">
              ...
              <span className="text-xs font-mono mx-auto" style={{ color: companion.shiny ? (RARITY_COLOR[companion.rarity] ?? '#a1a1aa') : 'rgb(113,113,122)' }}>
                {companion.species} — {companion.rarity}
                {companion.shiny && (
                  <span className="ml-1 animate-pulse">✨ SHINY</span>
                )}
              </span>
            </div>
